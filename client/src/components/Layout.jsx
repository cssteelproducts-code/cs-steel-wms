...
export default function Layout() {
  ...
  const sideW = open ? 160 : 0;

  return (
    <div style={{ position:'relative', width:'100vw', height:'100vh', overflow:'hidden', fontFamily:"'Noto Sans Thai','Noto Sans',sans-serif" }}>

      {/* ── Sidebar ── */}
      <aside style={{
        position:'absolute', left:0, top:0, bottom:0, width:sideW,
      ...
      {/* ── Topbar ── */}
      <header style={{
        position:'absolute', left:sideW, right:0, top:0, height:52,
        display:'flex', alignItems:'center', gap:10, padding:'0 20px',
        background:'#fff', borderBottom:'2px solid #CC0000',
        transition:'left .2s', zIndex:9,
      }}>
      ...
      <main style={{
        position:'absolute', left:sideW, right:0, top:52, bottom:0,
